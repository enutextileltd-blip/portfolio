...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    brandTagline: "“Weaving Tomorrow's Dreams in Every Thread…”",
    ...
    hotlineLabel: "Hotline: 01845-069803",
    hotlineNum: "01845-069803",
    ...
    dyeingFeat3Title: "OEKO-TEX Class I Safe Dyes",
    dyeingFeat3Desc: "Formulated with eco-friendly dyestuffs free from harmful amines, safe for infant wear and sensitive garments.",
  ...
  bn: {
    ...
    orderNow: "হোয়াটসঅ্যাপে অর্ডার করুন",
    callNow: "সরাসরি কল করুন",
    sendInquiry: "অনুসন্ধান পাঠান",
    requestSample: "শেড কার্ড রিকোয়েস্ট",
    hotlineLabel: "হটলাইন: ০১৮৪৫-০৬৯৮০৩",
    hotlineNum: "০১৮৪৫-০৬৯৮০৩",
    ...
    dyeingFeat3Title: "OEKO-TEX ক্লাস ১ পরিবেশবান্ধব ডাই",
    dyeingFeat3Desc: "ক্ষতিকারক রাসায়নিক মুক্ত যা শিশু ও স্পর্শকাতর ত্বকের পোশাকের জন্য শতভাগ নিরাপদ।",
